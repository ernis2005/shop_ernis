  ...
  return (
    <>
      ...
      <div className={s.sort}>
        ...
        <Stac className={s.Stac} data={data} />
      </div>
      <div className={s.inputfilter}>

      <input datatype="100" onChange={(e) => setLowerLimit(e.target.value)} placeholder="min"/>
        <input onChange={(e) => setUpperLimit(e.target.value)}  placeholder="max"/>
      </div>
